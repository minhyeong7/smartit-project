...
export default function RaderModal({raderResult,onClose}){


    return(
        <>
        {raderResult && <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
