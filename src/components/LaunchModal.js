...
export default function LaunchModal({launchResult,onClose}){
    return(
        <>
        {launchResult && <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
