...
export default function AlertModal({alertResult,onClose}){
   

    return(
        <>
        {alertResult && <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
